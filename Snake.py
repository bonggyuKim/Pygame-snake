    ...
    def GameLoop(self):
        ...
        while True:
            ...
            if(current == SnakeGame.direction["RIGHT"]and ret!=SnakeGame.direction["LEFT"]):
                ...
                self.board[self.snake.head[0]][self.snake.head[1]-1][SnakeGame.element["SPRITE"]]= SnakeGame.sprite["BODY"]
                ...
                self.board[self.snake.head[0]+1][self.snake.head[1]][SnakeGame.element["SPRITE"]]= SnakeGame.sprite["BODY"]
                
                ret = SnakeGame.direction["UP"]
                ...
                ret = SnakeGame.direction["DOWN"]
            
            x = self.snake.head[1]
            y = self.snake.head[0]
            temple = [y,x]
            for i in range(0,self.snake.length):
                if(self.board[y][x][SnakeGame.element["DIRECTION"]]==SnakeGame.direction["UP"]):
                    y+=1
                elif(self.board[y][x][SnakeGame.element["DIRECTION"]]==SnakeGame.direction["DOWN"]):
                    y-=1
                elif(self.board[y][x][SnakeGame.element["DIRECTION"]]==SnakeGame.direction["RIGHT"]):
                    x-=1
                elif(self.board[y][x][SnakeGame.element["DIRECTION"]]==SnakeGame.direction["LEFT"]):
                    x+=1
            temple = [y,x]
            self.board[temple[0]][temple[1]][SnakeGame.element["SPRITE"]] = SnakeGame.sprite["EMPTY"]
